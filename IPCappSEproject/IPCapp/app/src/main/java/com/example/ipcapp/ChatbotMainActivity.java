...
public class ChatbotMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.main_activityforchatbot);
    ...
    void showWelcomeMessage() {
        String welcomeMessage = "Welcome to the chat! How can I assist you?";
        addToChat(welcomeMessage, Message.SEND_BY_BOT);
    }
